...
const EventEmitter = () => {
  ...
  const ee = Object.create(EventEmitterPrototype);
 ...
 */
EventEmitter.isEventEmitter = thing => typeof thing === 'object' && Object.getPrototypeOf(thing) === EventEmitterPrototype;

export default EventEmitter;
export { EventEmitter }; // for browserify
